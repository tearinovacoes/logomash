	...
	<body>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<div class="jumbotron">
						<img style="float: left;" src="img/site/logo.png" alt="Tear Inovações" height="150" width="150"><h2 style="text-align: left;"><strong>Votação de logo Projeto AURORA</strong></h2>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<a href='index.php?<?php echo "won=$random1&lost=$random2"; ?>'><img src="img/image(<?php echo $random1; ?>).jpg" class="img-rounded" style="height:300px; max-width: 400px;"/></a>
						</div>
						<div class="col-md-2">
							<p style='text-align: center; vertical-align: middle; margin-top: 130px; margin-bottom: 130px;'>
								<strong>OU</strong>
							</p>
						</div>
						<div class="col-md-4">
							<a href='index.php?<?php echo "won=$random1&lost=$random2"; ?>'><img src="img/image(<?php echo $random2; ?>).jpg" class="img-rounded" style="height:300px; max-width: 400px;"/></a>
						</div>
						<div class="col-md-1"></div>
					</div>
